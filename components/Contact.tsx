				...
				<div ref={sectionRef}>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12">
						...
						<div className="flex flex-col gap-2.5">
							{links.map(({ label, href, preview }, index) => {
								const rowClassName =
									"flex items-center justify-between border border-border rounded-[4px] px-3.5 py-2.5 hover:border-foreground transition-colors group cursor-pointer";
								const rowContent = (
									<>
